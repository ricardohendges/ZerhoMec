...
type
  ...
  private
    ...
    Procedure CarregarFormMenuPrincipal;
...
begin
  ...
  Begin
    ...
    CarregarFormMenuPrincipal;

    frmLoginUsuario.Visible := False;
...
procedure TfrmLoginUsuario.CarregarFormMenuPrincipal;
begin

  AbrirForm('TfrmPrincipal');
